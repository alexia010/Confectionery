...
const ProductReviews = ({ product, deleteReview }) => {
  ...
  const handleDeleteReview = (productId, reviewId) => {
    ...
    if (productId === reviewId) {
      console.error('Error: productId and reviewId are the same:', productId);
      alert('Eroare: ID-ul recenziei este invalid.');
      return;
    }
  ...
  console.log('Product reviews:', product._id, reviews);
